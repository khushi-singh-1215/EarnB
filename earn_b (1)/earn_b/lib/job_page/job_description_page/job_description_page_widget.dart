...
class _JobDescriptionPageWidgetState extends State<JobDescriptionPageWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<JobCollectionRecord>(
      stream: JobCollectionRecord.getDocument(widget.jobRef!),
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: PreferredSize(
              ...
              child: AppBar(
                backgroundColor: const Color(0xFFFCC122),
                      ...
                      Expanded(
                        child: StreamBuilder<CompanyProfileRecord>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final tabBarCompanyProfileRecord = snapshot.data!;
                            return Column(
                              children: [
                                Align(
