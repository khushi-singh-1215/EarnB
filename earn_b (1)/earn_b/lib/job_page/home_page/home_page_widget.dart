    ...
    return GestureDetector(
      ...
      child: Scaffold(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('ExperienceAll');
                        },
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            backgroundColor: const Color(0xFFF9F997),
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<JobCollectionRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<JobCollectionRecord> rowJobCollectionRecordList =
                          snapshot.data!;
                      return SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: List.generate(
                              rowJobCollectionRecordList.length, (rowIndex) {
                            final rowJobCollectionRecord =
                                rowJobCollectionRecordList[rowIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 10.0, 10.0, 10.0),
                              child: InkWell(
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      'jobRef': serializeParam(
                                        rowJobCollectionRecord.reference,
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<CompanyProfileRecord>(
                                      stream: CompanyProfileRecord.getDocument(
                                          rowJobCollectionRecord.companyRef!),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
                                                    ...
                                                    Align(
                                                      alignment:
                                                          const AlignmentDirectional(
                                                              0.0, 0.0),
                                                      child: Text(
                                                        '₹ ${rowJobCollectionRecord.jSalary}/year',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                    ...
                    StreamBuilder<List<JobCollectionRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<JobCollectionRecord>
                            listViewJobCollectionRecordList = snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          primary: false,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewJobCollectionRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewJobCollectionRecord =
                                listViewJobCollectionRecordList[listViewIndex];
                            return Padding(
                              padding: const EdgeInsets.all(10.0),
                              child: InkWell(
                                splashColor: Colors.transparent,
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      'ref': serializeParam(
                                        listViewJobCollectionRecord.reference,
                                        ParamType.DocumentReference,
                                      ),
                                      'jobid': serializeParam(
                                        '',
                                          ...
                                          return Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Text(
                                                    '₹ ${listViewJobCollectionRecord.jSalary}/year',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyLarge
                                                        .override(
