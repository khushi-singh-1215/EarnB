...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1EA060);
  late Color secondary = const Color(0xFF5BB677);
  late Color tertiary = const Color(0xFFA5E0BB);
  late Color alternate = const Color(0xFFF86B1A);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFF0F0F0);
  late Color secondaryBackground = const Color(0xFFB8D8C8);
  late Color accent1 = const Color(0xFF616161);
  late Color accent2 = const Color(0xFF757575);
  late Color accent3 = const Color(0xFFE0E0E0);
  late Color accent4 = const Color(0xFFEAE0E0);
