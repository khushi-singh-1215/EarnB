...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomePageWidget() : const StartPage2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'StartPage2',
          path: '/startPage2',
          builder: (context, params) => const StartPage2Widget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          builder: (context, params) => TrackWidget(
            ...
            jobCollectionRefl: params.getParam(
              'jobCollectionRefl',
              ParamType.DocumentReference,
              false,
              ['jobCollection'],
        ...
        FFRoute(
          name: 'AddResum',
          path: '/addResum',
          builder: (context, params) => const AddResumWidget(),
        ),
        FFRoute(
          name: 'Applications',
          path: '/applications',
        ...
        FFRoute(
          name: 'JobCategory',
          path: '/jobCategory',
          builder: (context, params) => const JobCategoryWidget(),
        ),
        FFRoute(
          name: 'Edit',
          path: '/edit',
        ...
        FFRoute(
          name: 'CategorySeeAll',
          path: '/categorySeeAll',
          builder: (context, params) => const CategorySeeAllWidget(),
        ),
        FFRoute(
          name: 'Companies',
          path: '/companies',
        ...
        FFRoute(
          name: 'JobProfile',
          path: '/jobProfile',
          builder: (context, params) => const JobProfileWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const CreateJobProfileWidget(),
        ),
        FFRoute(
          name: 'AllResume',
          path: '/allResume',
          builder: (context, params) => const AllResumeWidget(),
        ),
        FFRoute(
          name: 'candidate',
          path: '/candidate',
        ...
        FFRoute(
          ...
          builder: (context, params) => const EmployeeEducationWidget(),
        ),
        FFRoute(
          name: 'Expericence',
          path: '/expericence',
          builder: (context, params) => const ExpericenceWidget(),
        ),
        FFRoute(
          name: 'Education',
          path: '/education',
        ...
        FFRoute(
          name: 'ExperienceAll',
          path: '/experienceAll',
          builder: (context, params) => const ExperienceAllWidget(),
        ),
        FFRoute(
          name: 'SignIN',
          path: '/signIN',
